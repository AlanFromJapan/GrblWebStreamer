...
""")
            ...
            f.write(f"G1 X{ fromto[1][0] }Y{ fromto[0][1] }\n")
            f.write(f"G1 X{ fromto[1][0] }Y{ fromto[1][1] }\n")
            f.write(f"G1 X{ fromto[0][0] }Y{ fromto[1][1] }\n")
            f.write(f"G1 X{ fromto[0][0] }Y{ fromto[0][0] }\n")
            f.write("""
